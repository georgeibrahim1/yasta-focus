export default function ProfileStatus({ 
  ...
  return (
    <div className="flex items-center gap-5 bg-slate-700/50 backdrop-blur-sm rounded-full px-5 py-4 border border-slate-600/50">
      {/* Avatar */}
      <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-purple-500/50 flex-shrink-0">
        {avatarUrl ? (
          <img 
            src={avatarUrl} 
            alt={name} 
      ...
      <div className="flex flex-col gap-0.5 flex-1">
        ...
        <p className="text-base text-slate-300">Level {level}</p>
